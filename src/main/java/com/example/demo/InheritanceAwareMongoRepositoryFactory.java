...
public class InheritanceAwareMongoRepositoryFactory extends MongoRepositoryFactory {
    ...
    /**
     * Creates a new {@link MongoRepositoryFactory} with the given
    ...
    /**
     * Taken from the Spring Data for MongoDB source code and modified to return
     * InheritanceAwarePartTreeMongoQuery instead of PartTreeMongoQuery. It's a
     * static private part so copy/paste was the only way...
     */
    private static class MongoQueryLookupStrategy implements QueryLookupStrategy {
        ...
        public RepositoryQuery resolveQuery(Method method, RepositoryMetadata metadata, ProjectionFactory factory,
            ...
            if (namedQueries.hasQuery(namedQueryName)) {
                ...
                return new StringBasedMongoQuery(queryMethod, operations, EXPRESSION_PARSER,
                        (QueryMethodEvaluationContextProvider) evaluationContextProvider);
            } else {
